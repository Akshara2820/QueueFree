...
export default function PlaceCard({ place }) {
  ...
  return (
    <div className={`bg-white rounded-xl shadow-sm border border-gray-200 p-4 hover:shadow-md transition-shadow duration-200 cursor-pointer border-l-4 ${getBorderColor()}`}>
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-primary-50/30 to-primary-100/20 rounded-xl opacity-0 hover:opacity-100 transition-opacity duration-300"></div>
          ...
          <div className="flex gap-2 mb-3">
            {[
              ...
              <button
                ...
                className={`flex-1 px-2 py-2 rounded-md text-xs font-medium transition-colors duration-200 ${
                  reportLevel === level
